...
It runs as one container with no database and no accounts. Each artifact is a directory of plain files under `/data` — back up that directory and you have backed up everything.
